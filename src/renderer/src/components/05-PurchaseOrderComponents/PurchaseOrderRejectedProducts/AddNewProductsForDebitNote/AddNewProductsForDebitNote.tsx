...
import { Category, SubCategory, Branch, Supplier } from './AddNewProductsForDebitNote.interface'
import { Check } from 'lucide-react'
import { formatINRCurrency } from './AddNewProductsForDebitNote.function'
...
const AddNewProductsForDebitNote: React.FC<Props> = ({
  categories,
  subCategories,
  fromAddress,
  toAddress,
...
export default AddNewProductsForDebitNote
