...
import POCreateNewProducts from './POCreateNewProducts/POCreateNewProducts'

interface Category {}

const PurchaseOrderProductCreation: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Sidebar
        ...
        position="right"
        header={editMode ? 'Edit Category' : 'Add New Products'}
        onHide={() => {
...
export default PurchaseOrderProductCreation
