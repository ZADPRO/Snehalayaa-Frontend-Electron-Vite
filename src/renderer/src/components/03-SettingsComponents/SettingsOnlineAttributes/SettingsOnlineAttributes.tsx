...
import { Attribute } from './SettingsOnlineAttributes.interface'
import { fetchAttribute } from './SettingsOnlineAttributes.function'
import { Toolbar } from 'primereact/toolbar'
import { Button } from 'primereact/button'
import { Pencil, Plus } from 'lucide-react'
import { Sidebar } from 'primereact/sidebar'
import { Dialog } from 'primereact/dialog'
import PreviewForm from '../SettingsAttributes/PreviewForm/PreviewForm'
import SettingsAddEditOnlineAttributes from './SettingsAddEditOnlineAttributes/SettingsAddEditOnlineAttributes'

const SettingsOnlineAttributes: React.FC = () => {
  ...
  return (
    <div>
      <div>
        ...
        >
          <SettingsAddEditOnlineAttributes
...
export default SettingsOnlineAttributes
