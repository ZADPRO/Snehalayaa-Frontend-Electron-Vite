...
const POSmanagementOverview: React.FC = () => {
  ...
  const [customers] = useState([
    { refCustomerId: 1, refCustomerName: 'Vijay', refMobileNo: '9876543210', refAddress: '123 Main St', refCity: 'Mumbai', refPincode: '400001', refState: 'Maharashtra', refCountry: 'India', refMembershipNumber: 'MEM001', refTaxNumber: 'GST123456789' },
    { refCustomerId: 2, refCustomerName: 'soniya', refMobileNo: '9876543211', refAddress: '456 Oak Ave', refCity: 'Delhi', refPincode: '110001', refState: 'Delhi', refCountry: 'India', refMembershipNumber: 'MEM002', refCustomerGroup: 'Regular', refTaxNumber: 'GST987654321' }
  ]);
  ...
  return (
    <div className="sales-dashboard ">
      ...
      <TabView activeIndex={activeTab} onTabChange={(e) => setActiveTab(e.index)}>
        {/* Sales Tab */}
        <TabPanel header="Recent Sales" leftIcon="pi pi-shopping-cart mr-2">
        ...
        {/* Customers Tab */}
        <TabPanel header="Recent Customer " leftIcon="pi pi-users mr-2">
          <div className="flex justify-between items-center">
